...
const ELEVATION_FORWARD_QUATERNION = Object.freeze(new Quaternion(0, 0, 0, 1))
...
// TODO: Remove usage of examples and addons subdirectory and use three-stdlib for versioned support.
